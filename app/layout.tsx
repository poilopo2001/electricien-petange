...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Électricien Dudelange | Dépannage 24/7 | Intervention < 2h',
    template: '%s | Électricien Dudelange',
  },
  description:
    'Électricien professionnel à Dudelange. Dépannage électrique d\'urgence 24/7, installation complète, mise aux normes. Intervention rapide en moins de 2h. Devis gratuit.',
  keywords: [
